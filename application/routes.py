...
from flask import render_template,request,jsonify,json,Response,redirect,flash,url_for,session
...
# @app.route('/api/')
# @app.route('/api/<idx>') #pass id index for index in json
# def api(idx=None):
#     if(idx==None):
#         jdata = courseData
#     else:
